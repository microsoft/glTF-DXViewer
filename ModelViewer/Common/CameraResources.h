...
namespace DXHelper
{
    ...
    public:
        ...
        void ReleaseResourcesForBackBuffer(DXHelper::HolographicDeviceResources* pDeviceResources);
        ...
        bool AttachViewProjectionBuffer(std::shared_ptr<DXHelper::HolographicDeviceResources> deviceResources);
