...
DXHelper::HolographicDeviceResources::HolographicDeviceResources()
{
...
void DXHelper::HolographicDeviceResources::CreateDeviceIndependentResources()
{
...
void DXHelper::HolographicDeviceResources::SetHolographicSpace(HolographicSpace holographicSpace)
{
...
void DXHelper::HolographicDeviceResources::InitializeUsingHolographicSpace()
{
...
void DXHelper::HolographicDeviceResources::CreateDeviceResources()
{
...
void DXHelper::HolographicDeviceResources::EnsureCameraResources(HolographicFrame frame, HolographicFramePrediction prediction)
{
...
// Locks the set of holographic camera resources until the function exits.
void DXHelper::HolographicDeviceResources::AddHolographicCamera(HolographicCamera camera)
{
...
// Locks the set of holographic camera resources until the function exits.
void DXHelper::HolographicDeviceResources::RemoveHolographicCamera(HolographicCamera camera)
{
    UseHolographicCameraResources([this, camera](std::map<UINT32, std::unique_ptr<CameraResources>>& cameraResourceMap) {
...
// Locks the set of holographic camera resources until the function exits.
void DXHelper::HolographicDeviceResources::HandleDeviceLost()
{
...
void DXHelper::HolographicDeviceResources::RegisterDeviceNotify(DX::IDeviceNotify* deviceNotify)
{
...
void DXHelper::HolographicDeviceResources::Trim()
{
    m_d3dContext->ClearState();
...
// Locks the set of holographic camera resources until the function exits.
void DXHelper::HolographicDeviceResources::Present(HolographicFrame frame)
{
