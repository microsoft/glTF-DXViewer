...
ModelViewerMain::~ModelViewerMain()
{
...
void ModelViewerMain::CreateWindowSizeDependentResources() 
{
	// TODO: Replace this with the size-dependent initialization of your app's content.
	m_sceneRenderer->CreateWindowSizeDependentResources();
}

void ModelViewerMain::StartRenderLoop()
{
...
void ModelViewerMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Updates the application state once per frame.
void ModelViewerMain::Update() 
{
	ProcessInput();
...
void ModelViewerMain::OnDeviceLost()
{
...
void ModelViewerMain::OnDeviceRestored()
{
